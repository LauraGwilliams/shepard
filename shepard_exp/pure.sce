...
infile1.open("scaleAPure.txt");
infile2.open("scaleCPure.txt");
infile3.open("scaleEbPure.txt");
input_file infile4 = new input_file;
input_file infile5 = new input_file;
input_file infile6 = new input_file;
infile4.open("scaleAPure.txt");
infile5.open("scaleCPure.txt");
infile6.open("scaleEbPure.txt");
...
string filename = logPath+"logs\\"+logfile.subject()+"_pure_"+date_time("yyyymmddhhnn")+".txt";
